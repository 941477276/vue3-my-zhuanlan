export default {
  ...
  customized: {
    ...
    custmizeWay1: 'Use the {bsicon} component provided by bs-icon-vue',
    custmizeWay2: 'Use the generation tool provided by bs-icon-vue',
    ...
    usageGuide2Title: 'Use the bs-icon-vue generation tool to generate custom icons',
