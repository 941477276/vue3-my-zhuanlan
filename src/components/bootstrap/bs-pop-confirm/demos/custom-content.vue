...
## zh-CN
可以通过`content`插槽或`raw-content`属性来自定义Confirm的内容

## en-US
The content of the Confirm can be customized through the `content` slot or the `raw-content` prop
</docs>

<template>
  <div>
    <bs-pop-confirm placement="bottom-start" @confirm="onConfirm">
