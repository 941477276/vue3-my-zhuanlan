...
## zh-CN
设置`custom-transition-name`属性可自定义过渡名称，它接收一个`Function`，该函数需返回一个`string`类型的名称

## en-US
Set the `custom-transition-name` attribute to customize the transition name, which receives a `Function`, which needs to return a name of type `string`
