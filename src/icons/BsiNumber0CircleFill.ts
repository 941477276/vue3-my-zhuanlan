...
export interface BsiNumber0CircleFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiNumber0CircleFill: BsiNumber0CircleFillType = function (props, ctx) {
...
export default BsiNumber0CircleFill;