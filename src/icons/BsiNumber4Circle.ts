...
export interface BsiNumber4CircleType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiNumber4Circle: BsiNumber4CircleType = function (props, ctx) {
...
export default BsiNumber4Circle;