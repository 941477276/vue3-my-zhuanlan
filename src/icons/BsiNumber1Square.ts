...
export interface BsiNumber1SquareType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiNumber1Square: BsiNumber1SquareType = function (props, ctx) {
...
export default BsiNumber1Square;