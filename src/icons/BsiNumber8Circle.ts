...
export interface BsiNumber8CircleType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiNumber8Circle: BsiNumber8CircleType = function (props, ctx) {
...
export default BsiNumber8Circle;