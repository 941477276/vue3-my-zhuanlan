...
export interface BsiNumber9CircleType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiNumber9Circle: BsiNumber9CircleType = function (props, ctx) {
...
export default BsiNumber9Circle;