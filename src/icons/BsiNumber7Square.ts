...
export interface BsiNumber7SquareType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiNumber7Square: BsiNumber7SquareType = function (props, ctx) {
...
export default BsiNumber7Square;