...
export interface BsiNumber4CircleFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiNumber4CircleFill: BsiNumber4CircleFillType = function (props, ctx) {
...
export default BsiNumber4CircleFill;