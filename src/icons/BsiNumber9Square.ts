...
export interface BsiNumber9SquareType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiNumber9Square: BsiNumber9SquareType = function (props, ctx) {
...
export default BsiNumber9Square;