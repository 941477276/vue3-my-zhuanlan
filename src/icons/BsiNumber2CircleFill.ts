...
export interface BsiNumber2CircleFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiNumber2CircleFill: BsiNumber2CircleFillType = function (props, ctx) {
...
export default BsiNumber2CircleFill;