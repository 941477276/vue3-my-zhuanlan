...
export interface BsiNumber4SquareFillType extends FunctionalComponent<BsIconProps> {
  displayName: string;
};

// define icon component
const BsiNumber4SquareFill: BsiNumber4SquareFillType = function (props, ctx) {
...
export default BsiNumber4SquareFill;